...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Args:
            ...
            id (int): The brand new Rectangle name.
        Raises:
            TypeError: If height or width are not integers.
            ValueError: If the height or width <= 0.
    ...
    @property
    def width(self):
        """The width of the rectangle can be changed."""
        return self.__width
    ...
    @property
    def height(self):
        """Set or obtain the rectangle height."""
    ...
    @property
    def y(self):
        """Change or obtain the Rectangle y coordinate."""
        return self.__y
    ...
    def update(self, *args, **kwargs):
        ...
        Args:
            ...
            **kwargs (dict): new key/value pair characteristics.
        """
    ...
    def to_dictionary(self):
        """The dictionary representation of Rectangle should be returned."""
        return {
            "id": self.id,
            "width": self.width,
            "height": self.height,
    ...
    def __str__(self):
        """Return the Rectangle print() and str() representations."""
