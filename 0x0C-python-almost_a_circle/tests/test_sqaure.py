...
class TestSquare_y(unittest.TestCase):
    """Unittests to check the Square y attribute initialization."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests check the initialization sequence Square attributes."""
...
class TestSquare_area(unittest.TestCase):
    """Unittests to check the Square class area method."""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests to check Square class __str__ and show methods."""

    @staticmethod
    def capture_stdout(sq, method):
        """Retrieves and copies text that was printed to stdout.

        Args:
            sq (Square): Square to print to stdout.
            method (str): The method to run sq.
        Returns:
            The text sent to stdout when method on sq is called.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests to check Square class update args function."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittests used to test the Square class update kwargs method."""
