...
class TestBase_instantiation(unittest.TestCase):
    """Unittests to check Base class instantiation."""
...
class TestBase_to_json_string(unittest.TestCase):
    """unit tests for the Base class to_json_string function."""
...
class TestBase_save_to_file(unittest.TestCase):
    """Unittests to test the Base class save_to_file function."""
...
class TestBase_from_json_string(unittest.TestCase):
    """Unit tests for the Base class from_json_string function."""
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """Unittests for checking the Base class save_to_file_csv function."""
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """Unittests to test the Base class load_from_file_csv function."""
