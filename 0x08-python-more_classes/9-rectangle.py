...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        ...
        Args:
            ...
            height (int): The new rectangle width height.
        """
    ...
    @property
    def height(self):
        """Obtain or modify the rectangle height."""
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Raises:
            TypeError: If neither rect_1 nor rect_2 are rectangles.
        """
    ...
    def square(cls, size=0):
        """Return new Rectangle with size adjusted width and height.

        Args:
            size (int): The width and height of new Rectangle width and height.
        """
        return (cls(size, size))

    def __str__(self):
        """Give me the Rectangle printable version again.

        Contains the character # to represent the rectangle.
        """
        if self.__width == 0 or self.__height == 0:
            return ("")
